document.addEventListener('DOMContentLoaded', function () {
  ...
  const toggleFields = [
    ...
    { id: 'spayedNeutered', options: ['YES', 'NO', 'N/A'] },
  ...
  editBtn.addEventListener('click', function () {
    ...
    if (isEditing) {
      ...
      const sponsorData = {
        ...
        Sponsor_Status: document.getElementById("status-select")?.value || document.getElementById("status").value,
        Grade: document.getElementById("militaryGrade").value,
        is_Dual_Military: document.getElementById("dualMilitary-select")?.value || document.getElementById("dualMilitary").value,
